...
1. Evaluation of the Development Process & Security Gaps (Prozessevaluierung & Lücken)
...
2. Proposed Security Gates (Empfohlene Security Gates)
...
3. CRA Compliance Assessment, Bewertung der Cyber Resilience Act Konformität
